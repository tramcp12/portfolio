...
│   ├── shared/                  # lang-switcher.js (IIFE 0) · scroll-reveal.js (IIFE 5) · lazy-loader.js (IIFE 6)
...
```html
<script id="lang-vi-data" type="application/json">
  {…}
</script>
<script id="lang-en-data" type="application/json">
  {…}
</script>
```
